...
public final class PasteAction extends jswingshell.action.AbstractJssAction implements LocaleChangeListener {
    ...
    private static final String ACTION_LABEL_KEY = "jssframe.action.paste.name";

    private static final String COMMAND_BRIEF_HELP = "Paste the content of the clipboard to the current selection.";

    private static final String COMMAND_BRIEF_HELP_KEY = "jssframe.action.paste.help.short";

    private static final String COMMAND_HELP_KEY = "jssframe.action.paste.help.long";
    ...
    // #########################################################################
    public PasteAction(JssTextAreaController shellController, String[] args) {
    ...
    public PasteAction(JssTextAreaController shellController) {
