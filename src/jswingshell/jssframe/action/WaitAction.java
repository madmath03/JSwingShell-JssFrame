...
public final class WaitAction extends AbstractThreadedJssAction implements LocaleChangeListener {
    ...
    private static final String COMMAND_BRIEF_HELP_KEY = "jssframe.action.wait.help.short";

    private static final String COMMAND_HELP_KEY = "jssframe.action.wait.help.long";

    private static final String COMMAND_RUN_INVALID_NUMBER_FORMAT_KEY = "jssframe.action.wait.run.invalid_number_format";

    private static final String COMMAND_RUN_NEGATIVE_TIME_KEY = "jssframe.action.wait.run.negative_time";

    private static final String COMMAND_RUN_INTERRUPTED_KEY = "jssframe.action.wait.run.interrupted";
