...
public final class CutAction extends jswingshell.action.AbstractJssAction implements LocaleChangeListener {
    ...
    private static final String ACTION_LABEL_KEY = "jssframe.action.cut.name";

    private static final String COMMAND_BRIEF_HELP = "Cut the current selection to the clipboard.";

    private static final String COMMAND_BRIEF_HELP_KEY = "jssframe.action.cut.help.short";

    private static final String COMMAND_HELP_KEY = "jssframe.action.cut.help.long";
    ...
    // #########################################################################
    public CutAction(JssTextAreaController shellController, String... args) {
    ...
    public CutAction(JssTextAreaController shellController) {
