...
public class PrintScreenAction extends jswingshell.action.AbstractThreadedJssAction implements LocaleChangeListener {
    ...
    private static final String COMMAND_BRIEF_HELP_KEY = "jssframe.action.print_screen.help.short";

    private static final String COMMAND_HELP_KEY = "jssframe.action.print_screen.help.long";

    private static final String COMMAND_RUN_FILE_MANDATORY_WARNING_KEY = "jssframe.action.print_screen.run.file_mandatory";

    private static final String COMMAND_RUN_FILE_PATH_INVALID_KEY = "jssframe.action.print_screen.run.file_path_invalid";

    private static final String COMMAND_RUN_FILE_WRITING_ERROR_KEY = "jssframe.action.print_screen.run.file_writing_error";

    private static final String COMMAND_RUN_FILE_CLOSING_ERROR_KEY = "jssframe.action.print_screen.run.file_closing_error";
