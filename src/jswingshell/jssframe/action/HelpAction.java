...
public final class HelpAction extends AbstractJssAction implements LocaleChangeListener {
    ...
    private static final String ACTION_LABEL_KEY = "jssframe.action.help.name";

    private static final String COMMAND_BRIEF_HELP = "Display available commands.";

    private static final String COMMAND_BRIEF_HELP_KEY = "jssframe.action.help.help.short";

    private static final String COMMAND_HELP_KEY = "jssframe.action.help.help.long";

    private static final String COMMAND_RUN_KEY = "jssframe.action.help.run";

    private static final String COMMAND_RUN_NOT_FOUND_WARNING_KEY = "jssframe.action.help.run.command_not_found";
