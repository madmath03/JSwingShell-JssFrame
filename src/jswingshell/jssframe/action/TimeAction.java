...
public final class TimeAction extends AbstractJssAction implements LocaleChangeListener {
    ...
    private static final String COMMAND_BRIEF_HELP_KEY = "jssframe.action.time.help.short";

    private static final String COMMAND_HELP_KEY = "jssframe.action.time.help.long";

    private static final String COMMAND_HELP_EXAMPLE_KEY = "jssframe.action.time.help.long.example";

    private static final String COMMAND_RUN_INVALID_DATE_FORMAT_KEY = "jssframe.action.time.run.invalid_date_format";

    private static final String COMMAND_RUN_INVALID_LANGUAGE_FORMAT_KEY = "jssframe.action.time.run.invalid_language_format";

    private static final String COMMAND_RUN_INVALID_COUNTRY_FORMAT_KEY = "jssframe.action.time.run.invalid_country_format";

    private static final String COMMAND_RUN_INVALID_VARIANT_FORMAT_KEY = "jssframe.action.time.run.invalid_variant_format";
