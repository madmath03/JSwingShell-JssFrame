...
public final class ToggleToolbarLargeIconsAction extends jswingshell.action.AbstractJssSwitchAction implements LocaleChangeListener {
    ...
    private static final String ACTION_LABEL_KEY = "jssframe.action.toggle_toolbar_large_icons.name";

    private static final String COMMAND_BRIEF_HELP = "Toggle the frame's toolbar's large icons display.";

    private static final String COMMAND_BRIEF_HELP_KEY = "jssframe.action.toggle_toolbar_large_icons.help.short";

    private static final String COMMAND_HELP_KEY = "jssframe.action.toggle_toolbar_large_icons.help.long";
