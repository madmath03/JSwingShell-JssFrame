...
public final class LocaleAction extends jswingshell.action.AbstractJssComboAction<Locale> implements LocaleChangeListener {
    ...
    private static final String ACTION_LABEL_KEY = "jssframe.action.locale.name";

    private static final String COMMAND_BRIEF_HELP = "Change the JVM default locale.";

    private static final String COMMAND_BRIEF_HELP_KEY = "jssframe.action.locale.help.short";

    private static final String COMMAND_HELP_KEY = "jssframe.action.locale.help.long";

    private static final String COMMAND_RUN_CURRENT_LOCALE_MESSAGE = "Current locale is ";

    private static final String COMMAND_RUN_CURRENT_LOCALE_MESSAGE_KEY = "jssframe.action.locale.run.current_locale";

    private static final String INTERNAL_COMMAND_BRIEF_HELP = "Sets the shell's locale to ";

    private static final String INTERNAL_COMMAND_BRIEF_HELP_KEY = "jssframe.action.locale.internal_command.help.short";
