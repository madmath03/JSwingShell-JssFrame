...
public final class ZoomAction extends jswingshell.action.AbstractJssAction implements LocaleChangeListener {
    ...
    private static final String ACTION_LABEL_KEY = "jssframe.action.zoom.name";

    private static final String COMMAND_BRIEF_HELP = "Change the size of the shell text.";

    private static final String COMMAND_BRIEF_HELP_KEY = "jssframe.action.zoom.help.short";

    private static final String COMMAND_HELP_KEY = "jssframe.action.zoom.help.long";

    private static final String COMMAND_RUN_INVALID_ARGUMENT_ERROR_KEY = "jssframe.action.zoom.run.invalid_argument_error";
