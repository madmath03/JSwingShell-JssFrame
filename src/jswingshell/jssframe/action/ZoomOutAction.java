...
public final class ZoomOutAction extends AbstractAction implements LocaleChangeListener {
    ...
    private static final String ACTION_LABEL_KEY = "jssframe.action.zoom_out.name";
    ...
    private static final String COMMAND_BRIEF_HELP_KEY = "jssframe.action.zoom_out.help.short";
