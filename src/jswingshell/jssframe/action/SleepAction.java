...
public final class SleepAction extends AbstractJssAction implements LocaleChangeListener {
    ...
    private static final String COMMAND_BRIEF_HELP_KEY = "jssframe.action.sleep.help.short";

    private static final String COMMAND_HELP_KEY = "jssframe.action.sleep.help.long";

    private static final String COMMAND_RUN_INVALID_NUMBER_FORMAT_KEY = "jssframe.action.sleep.run.invalid_number_format";

    private static final String COMMAND_RUN_NEGATIVE_TIME_KEY = "jssframe.action.sleep.run.negative_time";
