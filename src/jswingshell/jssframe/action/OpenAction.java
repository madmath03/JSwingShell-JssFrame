...
public final class OpenAction extends LoadCommandFile {
    ...
    private static final String ACTION_LABEL_KEY = "jssframe.action.open_command_file.name";

    private static final String COMMAND_RUN_FILE_FILTER_DESCRIPTION_KEY = "jssframe.action.open_command_file.run.file_filter_description";
