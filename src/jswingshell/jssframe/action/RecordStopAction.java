...
public final class RecordStopAction extends AbstractAction implements LocaleChangeListener {
    ...
    private static final String ACTION_LABEL_KEY = "jssframe.action.record_stop.name";
    ...
    private static final String COMMAND_BRIEF_HELP_KEY = "jssframe.action.record_stop.help.short";
