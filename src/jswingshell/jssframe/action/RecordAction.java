...
public final class RecordAction extends jswingshell.action.AbstractThreadedJssAction implements LocaleChangeListener {
    ...
    private static final String ACTION_LABEL_KEY = "jssframe.action.record.name";

    private static final String COMMAND_BRIEF_HELP = "Record the executed shell commands to a file.";

    private static final String COMMAND_BRIEF_HELP_KEY = "jssframe.action.record.help.short";

    private static final String COMMAND_HELP_KEY = "jssframe.action.record.help.long";

    private static final String COMMAND_RUN_FILE_WRITING_ERROR_KEY = "jssframe.action.record.run.file_writing_error";

    private static final String COMMAND_RUN_BUFFERED_FILE_CLOSING_ERROR_KEY = "jssframe.action.record.run.buffered_file_closing_error";

    private static final String COMMAND_RUN_FILE_CLOSING_ERROR_KEY = "jssframe.action.record.run.file_closing_error";
