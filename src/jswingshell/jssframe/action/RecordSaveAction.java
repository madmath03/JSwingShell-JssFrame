...
public final class RecordSaveAction extends AbstractJssAction implements LocaleChangeListener {
    ...
    private static final String ACTION_LABEL_KEY = "jssframe.action.record_save.name";
    ...
    private static final String COMMAND_BRIEF_HELP_KEY = "jssframe.action.record_save.help.short";
