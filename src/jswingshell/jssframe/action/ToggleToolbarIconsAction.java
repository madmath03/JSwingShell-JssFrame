 ...
 *
 * <p>
 * This action is deigned for a {@link JssFrame} and initializes GUI related
 * properties:</p>
 * <ul>
...
public final class ToggleToolbarIconsAction extends jswingshell.action.AbstractJssSwitchAction implements LocaleChangeListener {
    ...
    private static final String ACTION_LABEL_KEY = "jssframe.action.toggle_toolbar_icons.name";

    private static final String COMMAND_BRIEF_HELP = "Toggle the frame's toolbar's icons display.";

    private static final String COMMAND_BRIEF_HELP_KEY = "jssframe.action.toggle_toolbar_icons.help.short";

    private static final String COMMAND_HELP_KEY = "jssframe.action.toggle_toolbar_icons.help.long";
    ...
    public ToggleToolbarIconsAction(boolean selected, JssFrame frame, JssTextAreaController shellController, String... args) {
    ...
    public ToggleToolbarIconsAction(JssFrame frame, JssTextAreaController shellController, String... args) {
        this(false, frame, shellController, args);
    }

    public ToggleToolbarIconsAction(JssFrame frame, JssTextAreaController shellController) {
        this(false, frame, shellController, (String[]) null);
    }

    public ToggleToolbarIconsAction(JssFrame frame) {
    ...
    public void setFrame(JssFrame frame) {
        this.frame = frame;
    }
