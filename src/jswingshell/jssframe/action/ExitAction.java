...
public final class ExitAction extends AbstractJssAction implements LocaleChangeListener {
    ...
    private static final String ACTION_LABEL_KEY = "jssframe.action.exit.name";

    private static final String COMMAND_BRIEF_HELP = "Exits application.";

    private static final String COMMAND_BRIEF_HELP_KEY = "jssframe.action.exit.help.short";

    private static final String COMMAND_HELP_KEY = "jssframe.action.exit.help.long";

    private static final String COMMAND_RUN_INVALID_RETURN_CODE_WARNING_KEY = "jssframe.action.exit.run.invalid_return_code";
    ...
    public int run(IJssController shellController, String[] args) {
        ...
        Serialization.saveSerializedModel(getDefaultShellController().getModel());
//        Serialization.saveSerializedAction(getDefaultShellController().getActionForCommandIdentifier(LevelAction.DEFAULT_IDENTIFIER));
