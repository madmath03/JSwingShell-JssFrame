...
public final class ToggleToolbarLocaleCombo extends jswingshell.action.AbstractJssSwitchAction implements LocaleChangeListener {
    ...
    private static final String ACTION_LABEL_KEY = "jssframe.action.toggle_toolbar_locale_combo.name";

    private static final String COMMAND_BRIEF_HELP = "Toggle the frame's toolbar's locale combo box display.";

    private static final String COMMAND_BRIEF_HELP_KEY = "jssframe.action.toggle_toolbar_locale_combo.help.short";

    private static final String COMMAND_HELP_KEY = "jssframe.action.toggle_toolbar_locale_combo.help.long";
