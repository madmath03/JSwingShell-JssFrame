...
public final class FullScreenAction extends jswingshell.action.AbstractJssSwitchAction implements LocaleChangeListener {
    ...
    private static final String ACTION_LABEL_KEY = "jssframe.action.fullscreen.name";

    private static final String COMMAND_BRIEF_HELP = "Toggle the frame's full screen mode.";

    private static final String COMMAND_BRIEF_HELP_KEY = "jssframe.action.fullscreen.help.short";

    private static final String COMMAND_HELP_KEY = "jssframe.action.fullscreen.help.long";

    private static final String COMMAND_RUN_NOT_SUPPORTED_WARNING_KEY = "jssframe.action.fullscreen.run.not_supported";
