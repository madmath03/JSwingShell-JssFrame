...
public final class EchoAction extends AbstractJssAction implements LocaleChangeListener {
    ...
    private static final String COMMAND_BRIEF_HELP_KEY = "jssframe.action.echo.help.short";

    private static final String COMMAND_HELP_KEY = "jssframe.action.echo.help.long";
