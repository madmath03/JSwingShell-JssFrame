...
public final class ClearAction extends AbstractJssAction implements LocaleChangeListener {
    ...
    private static final String COMMAND_BRIEF_HELP_KEY = "jssframe.action.clear.help.short";

    private static final String ACTION_LABEL = "Clear";

    private static final String ACTION_LABEL_KEY = "jssframe.action.clear.name";
