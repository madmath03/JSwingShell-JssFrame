...
public final class SaveScreenAction extends PrintScreenAction {
    ...
    private static final String ACTION_LABEL_KEY = "jssframe.action.save_screen.name";

    private static final String COMMAND_RUN_FILE_FILTER_DESCRIPTION_KEY = "jssframe.action.save_screen.run.file_filter_description";
