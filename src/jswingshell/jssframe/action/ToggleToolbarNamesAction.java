...
public final class ToggleToolbarNamesAction extends jswingshell.action.AbstractJssSwitchAction implements LocaleChangeListener {
    ...
    private static final String ACTION_LABEL_KEY = "jssframe.action.toggle_toolbar_names.name";

    private static final String COMMAND_BRIEF_HELP = "Toggle the frame's toolbar's names display.";

    private static final String COMMAND_BRIEF_HELP_KEY = "jssframe.action.toggle_toolbar_names.help.short";

    private static final String COMMAND_HELP_KEY = "jssframe.action.toggle_toolbar_names.help.long";
    ...
    public ToggleToolbarNamesAction(boolean selected, JssFrame frame, JssTextAreaController shellController, String[] args) {
    ...
    public ToggleToolbarNamesAction(JssFrame frame, JssTextAreaController shellController, String[] args) {
        this(false, frame, shellController, args);
    }

    public ToggleToolbarNamesAction(JssFrame frame, JssTextAreaController shellController) {
        this(false, frame, shellController, null);
    }

    public ToggleToolbarNamesAction(JssFrame frame) {
