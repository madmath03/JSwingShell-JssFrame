...
public final class ToggleToolbarAction extends jswingshell.action.AbstractJssSwitchAction implements LocaleChangeListener {
    ...
    private static final String ACTION_LABEL_KEY = "jssframe.action.toggle_toolbar.name";

    private static final String COMMAND_BRIEF_HELP = "Toggle the frame's toolbar display.";

    private static final String COMMAND_BRIEF_HELP_KEY = "jssframe.action.toggle_toolbar.help.short";

    private static final String COMMAND_HELP_KEY = "jssframe.action.toggle_toolbar.help.long";
