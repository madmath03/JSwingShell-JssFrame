...
public final class LevelAction extends jswingshell.action.AbstractJssComboAction<IJssController.PublicationLevel> implements LocaleChangeListener {
    ...
    private static final String ACTION_LABEL_KEY = "jssframe.action.level.name";

    private static final String COMMAND_BRIEF_HELP = "Define the shell's log level.";

    private static final String COMMAND_BRIEF_HELP_KEY = "jssframe.action.level.help.short";

    private static final String COMMAND_HELP_KEY = "jssframe.action.level.help.long";

    private static final String COMMAND_RUN_NEW_LEVEL_MESSAGE = "Shell level set to ";

    private static final String COMMAND_RUN_NEW_LEVEL_MESSAGE_KEY = "jssframe.action.level.run.new_level";

    private static final String INTERNAL_COMMAND_BRIEF_HELP = "Sets the shell's log level to ";

    private static final String INTERNAL_COMMAND_BRIEF_HELP_KEY = "jssframe.action.level.internal_command.help.short";
