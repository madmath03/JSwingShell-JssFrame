...
public final class ToggleToolbarLevelCombo extends jswingshell.action.AbstractJssSwitchAction implements LocaleChangeListener {
    ...
    private static final String ACTION_LABEL_KEY = "jssframe.action.toggle_toolbar_level_combo.name";

    private static final String COMMAND_BRIEF_HELP = "Toggle the frame's toolbar's level combo box display.";

    private static final String COMMAND_BRIEF_HELP_KEY = "jssframe.action.toggle_toolbar_level_combo.help.short";

    private static final String COMMAND_HELP_KEY = "jssframe.action.toggle_toolbar_level_combo.help.long";
